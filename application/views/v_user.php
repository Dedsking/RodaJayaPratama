                    ...
                    foreach ($user as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <button data-toggle="modal" data-target="#detail<?= $value->id_user; ?>" class="btn btn-primary btn-sm"><i class="fas fa-tag"></i></button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>No Tlp</label>
                    <input type="text" name="no_tlp" class="form-control" placeholder="No Tlp" required>
                </div>
                <div class="form-group">
                    <label>Alamat</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>No Tlp</label>
                        <input type="text" name="no_tlp" value="<?= $value->no_tlp; ?>" class="form-control" placeholder="No Tlp" required>
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
...
<!-- modal detail -->
<?php foreach ($user as $key => $value) { ?>
    <div class="modal fade" id="detail<?= $value->id_user; ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
