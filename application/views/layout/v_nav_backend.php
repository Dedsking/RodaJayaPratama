          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('suplier') ?>" class="nav-link <?php if ($this->uri->segment(1) == 'suplier') {
                                                                                echo 'active';
                                                                            } ?>" class="nav-link ">
                  ...
                  <!-- <li class="nav-item">
                      <a href="<?= base_url('service') ?>" class="nav-link <?php if ($this->uri->segment(1) == 'service') {
                                                                                echo 'active';
                                                                            } ?>">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('admin/pelanggan') ?>" class="nav-link <?php if ($this->uri->segment(2) == 'pelanggan' and $this->uri->segment(1) == 'admin') {
                                                                                        echo 'active';
                                                                                    } ?>" class="nav-link ">
