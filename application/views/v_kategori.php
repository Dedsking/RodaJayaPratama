                    ...
                    foreach ($kategori as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <button data-toggle="modal" data-target="#detail<?= $value->id_kategori; ?>" class="btn btn-primary btn-sm"><i class="fas fa-tag"></i></button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Nama Kategori</label>
                        <input type="text" value="<?= $value->nama_kategori; ?>" name="nama_kategori" class="form-control" placeholder="Nama Kategori" required>
                    </div>
                    <!-- <div class="form-group">
                    <label>Level User</label>
                    <select name="level_user" class="form-control">
...
<!-- modal detail -->
<?php foreach ($kategori as $key => $value) { ?>
    <div class="modal fade" id="detail<?= $value->id_kategori; ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
