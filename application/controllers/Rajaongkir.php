...
{
    private $api_key = '25454fe4a3ba525f1ac5045dd504ec0b';
    ...
    public function provinsi()
    {
        ...
        if ($err) {
            ...
            // echo '<pre>';
            // print_r($array_responce['rajaongkir']['results']);
            // echo '</pre>';
            $data_provinsi =   $array_responce['rajaongkir']['results'];
    ...
    public function kota()
    {
        ...
        if ($err) {
            ...
            $array_responce = json_decode($response, TRUE);
            $data_kota =   $array_responce['rajaongkir']['results'];
    ...
    {
        //mengabil id kota asal di tabel setting
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_POSTFIELDS => "origin=457&destination=" . $id_kota . "&weight=" . $berat . "&courier=$expedisi",
            CURLOPT_HTTPHEADER => array(
        ...
        if ($err) {
            ...
            $array_responce = json_decode($response, TRUE);
            // echo '<pre>';
            // print_r($array_responce['rajaongkir']['results'][0]['costs']);
            // echo '</pre>';
            $data_paket = $array_responce['rajaongkir']['results'][0]['costs'];
